        ...
        <section className="min-h-screen py-5 px-40 bg-neutral-800 w-full">
            <div className="flex flex-col gap-40">
                <nav className="flex text-white items-center justify-between">
                    ...
                    <a target='_blank' rel='noreferrer' className="text-lg shadow-xl shadow-neutral-900 bg-gradient-to-r from-orange-700 to-orange-500 px-4 py-2 rounded-md" href="https://drive.google.com/drive/folders/1fWAhxydf_V6JITInDGKHplb5bbvgAt8X">Resume</a>
                </nav>
